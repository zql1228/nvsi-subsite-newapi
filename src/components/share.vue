    ...
    >
      <div class="mask-header row w">
        ...
        <div class="col v-m t-r">
          <a href="javascript:void(0);" class="mask-close" @click="closeMask"
      ...
      <div class="VX_code" style="margin-top: 10px">
        ...
        <div v-else style="text-align: center">
          <img src="@/assets/img/erwei.jpg" width="200px" height="200px" />
        </div>
    ...
    get() {
      let host =
        window.location.host == "wuhan.yxybb.com"
          ...
          : "https://chinavolunteer.mca.gov.cn";
      let id = this.$route.params.data1;
      let areaid = this.$route.params.data2;
      if (this.type == "pro") {
        // 项目
        this.url = `${host}/nvsidfh5/projectShare/${id}/${areaid}`;
      } else if (this.type == "group") {
        // 队伍
        this.url = `${host}/nvsidfh5/groupShare/${id}/${areaid}`;
      }
    },
    closeMask() {
