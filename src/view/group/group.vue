          ...
          <div class="category">
            ...
            <div class="category__content">
              ...
              <a
                ...
                :key="item.id"
                @click="serviceTypeChoose($event, item.codeid)"
                >{{ item.codevalue }}</a
              >
            </div>
          </div>
          ...
          <div id="getList">
            <ul class="panel-list panel-lists">
              ...
              <li
                ...
                :key="index"
                @click="$utilroutes.toGroupInfo(item.id, item.albe0012)"
              >
...
export default {
  ...
  methods: {
    ...
    getdate() {
      ...
      this.utilscommit.requestapi(
        "queryTeamPageWeb",
        { albe0036: 1, areaid: this.areaid, pageSize: 4, pageNum: 1 },
    ...
    // 团体类型
    getProjectTtlx() {
      getCodeList("codeValueQueryFortisWeb", "nvsi_albe0005", {
        tablename: "nvsi_albe0005"
      }).then(res => {
        this.orgTypeList = this.common.orderBy(res, "orderid", "asc");
      });
    },
    //区域
    getProjectYjqy(params) {
      getCodeList("getNextAreaListFortisWeb", "firstArea", params).then(res => {
